...
def get_camera(username):
    ...
    data = Camera.get_camera_by_id(str(id), username)  
...
@token_required
def add_new_camera(current_user, username):
    """
    ...
    if request.method == 'POST':
        try:
            ...
            req_fields = ['name', 'ip_address', "username", "password", "rtsp_url"]
            ...
            return {'message':"Camera has been added."},  201
